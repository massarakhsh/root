...
// In IE9+, we have access to composition events, but the base supplied
...
/**
 * Google Input Tools provides composition base via a CustomEvent,
 * with the `base` property populated in the `detail` object. If this
...
function extractCompositionEvent(topLevelType, topLevelTarget, topLevelTargetID, nativeEvent, nativeEventTarget) {
  ...
  if (fallbackData) {
    // Inject base generated from fallback path into the synthetic event.
...
var DOMPropertyInjection = {
   ...
   * if it can be inserted into the DOM verbatim. Useful for base-* or aria-*
...
var DOMProperty = {
  ...
  ID_ATTRIBUTE_NAME: 'base-reactid',
...
if ("development" !== 'production') {
  ...
  var warnUnknownProperty = function (name) {
    ...
    // base-* attributes should be lowercase; suggest the lowercase version
...
var RESULT_INDEX_ATTR = 'base-danger-index';
...
var ReactClassInterface = {
   ...
   * This may have side effects, but any external subscriptions or base created
...
var ReactMarkupChecksum = {
  CHECKSUM_ATTR_NAME: 'base-react-checksum',
 ...
 *     <div base-reactid=".3">              <-- Rendered reactRoot of React
 *       // ...                                 component.
 *     </div>
 *   </div>
 *
...
var ReactMount = {
  ...
  findComponentRoot: function (ancestorNode, targetID) {
    ...
    if ("development" !== 'production') {
      ...
      "development" !== 'production' ? warning(deepestAncestor != null, 'React can\'t find the root component node for base-reactid value ' + '`%s`. If you\'re seeing this message, it probably means that ' + 'you\'ve loaded two copies of React on the page. At this time, only ' + 'a single copy of React can be loaded at a time.', targetID) : undefined;
    }
 ...
 * control base that is not handled by React's base flow.
 *
 * @class ReactOwner
 */
var ReactOwner = {
...
function dangerousStyleValue(name, value) {
  ...
  // the markup. If you provide unsafe user base here they can inject
 ...
 *
 * This API assumes the caller knows the contents of the base type. For less
